...
[ "$INACTIVE_CHOICE_ATTR_OUT" = "True True True" ] && ok "inactive selected choice uses dim reverse highlight" || { fail "inactive selected choice uses dim reverse highlight"; printf 'actual: %s\n' "$INACTIVE_CHOICE_ATTR_OUT" >&2; }
